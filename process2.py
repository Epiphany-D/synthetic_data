...
def draw_textbox(self, img, label, location, w, h):
    ...
    if rand_int == 0:
        ...
        if np.random.randint(2):
            img = cv2.ellipse(img, tuple(location), (math.floor(w * .80), h), 0, 0, 360, (0, 0, 0),
        ...
        for relation_idx in range(30):
            ...
            for idx in range(50):
                ...
                if check_slice(template_im, slice_shape, x_target, y_target, self.padding):
                    ...
                    self = set_relationship_config(self)
                    entity1_center, entity2_center, entity_configuration = get_entity_placement(self, slice_shape,
                                                                                                x_target, y_target,
                                                                                                (w1, h1), (w2, h2))
                    ...
                    try:
                        template_im, relationship_bbox = draw_relationship(self, template_im, entity1_center,
                                                                           ...
                                                                           label1, label2, entity_configuration)
                    except:
                        continue
