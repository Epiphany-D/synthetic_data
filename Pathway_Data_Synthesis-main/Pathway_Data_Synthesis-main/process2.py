        ...
        for test_idx in range(len(shape2_x)):
            ...
            for entity in placed_entities:
                ...
                if entity['type'] == ELLIPSE:
                    ...
                    p = check_ellipse_point(ref_center[0], ref_center[1], updated_x, updated_y, ref_width,
                                            entity['height'])
                elif entity['type'] == RECT:
                    ref_width = entity['width'] + self.text_margin * 2
                    p = check_rect_point(ref_center[0], ref_center[1], updated_x, updated_y, ref_width,
                                         entity['height'] + (self.text_margin * 2))
...
def draw_relationship(self, img, entity1_center, entity2_center, entity_configuration, placed_entities1,
    ...
    for idx in range(len(placed_entities1)):
        ...
        self.text_color = (
        255 - self.textbox_background[0], 255 - self.textbox_background[1], 255 - self.textbox_background[2])
        ...
        for relation_idx in range(50):
            ...
            for idx in range(50):
                ...
                if check_slice(template_im, slice_shape, x_target, y_target, self.padding):
                    ...
                    template_im = cv2.rectangle(template_im, (x_target - self.padding, y_target - self.padding),
                                                (x_target + x_dim + self.padding, y_target + y_dim + self.padding),
                                                (0, 0, 0), 1)
                    ...
                    entity1_center, entity2_center, entity_configuration, template_im = get_entity_placement(self,
                                                                                                             slice_shape,
                                                                                                             x_target,
                                                                                                             y_target,
                                                                                                             (w1, h1),
